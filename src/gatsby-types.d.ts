...
type BlogPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly name: string, readonly publicURL: string | null, readonly relativePath: string, readonly internal: { readonly contentDigest: string } } }> }, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly rawMarkdownBody: string | null, readonly frontmatter: { readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null } | null } | null, readonly previous: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null, readonly next: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null };
...
type GetAboutQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly rawMarkdownBody: string | null, readonly frontmatter: { readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null } | null } | null };

type GetMemoriesQueryVariables = Exact<{ [key: string]: never; }>;


type GetMemoriesQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null } | null }> } };

type GetNewsQueryVariables = Exact<{ [key: string]: never; }>;


type GetNewsQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null } | null }> } };

type GetAllMarkdownFilesQueryVariables = Exact<{ [key: string]: never; }>;


type GetAllMarkdownFilesQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null }> } };
